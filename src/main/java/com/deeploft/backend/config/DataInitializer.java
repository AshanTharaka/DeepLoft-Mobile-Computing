...
public class DataInitializer {
    ...
    CommandLineRunner initDatabase(CourseRepository repository, QuizRepository quizRepository) {
        return args -> {
            ...
            Course c1 = repository.save(new Course(null, "Android Development with Java", "Ashan", 49.99, "Learn Android from scratch.", "", "Development", Arrays.asList(l1, l2)));
            ...
            Course c2 = repository.save(new Course(null, "AI for Beginners", "DeepLoft AI", 0.00, "Intro to AI concepts.", "", "Artificial Intelligence", Arrays.asList(l3, l4)));
            ...
            repository.save(new Course(null, "Web Dev Bootcamp", "John Doe", 89.99, "Fullstack web development.", "", "Development", Arrays.asList(
