...
public class CourseContentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initializePlayer(); // Initialize player BEFORE starting video
    ...
    private void toggleFullScreen() {
        View appBar = findViewById(R.id.app_bar_learning);
        View scrollView = findViewById(R.id.nsv_learning_content);
        View mainContainer = findViewById(R.id.main_content_container);
        
        androidx.coordinatorlayout.widget.CoordinatorLayout.LayoutParams params = 
                (androidx.coordinatorlayout.widget.CoordinatorLayout.LayoutParams) mainContainer.getLayoutParams();
