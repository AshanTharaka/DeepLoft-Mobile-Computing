...
public class StudentCourseAdapter extends RecyclerView.Adapter<StudentCourseAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // Calculate progress (Mocking for now as Enrollment might not have total lessons count easily available here)
        ...
        holder.itemView.setOnClickListener(v -> listener.onContinue(enrollment));
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ImageView ivImage;
        TextView tvTitle, tvInstructor, tvProgress, btnContinue;
